<%@ page language="C#" autoeventwireup="true" inherits="SSOLogOn, App_Web_ssologon.aspx.27254924" enableEventValidation="false" %>
    ...
    <form id="form1" runat="server" onsubmit="return checkinput($('#ddlAuthenTypeList').attr('value'));">
        <div class="content login clfx">
            <ul class="listC clfx">
                ...
                <li id="tabD2" onclick="tabconD(2);">商家登录</li>
            </ul>
