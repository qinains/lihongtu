...
<%@ page language="C#" autoeventwireup="true" inherits="SSO_BesttoneLoginForm, App_Web_besttoneloginform.aspx.27254924" enableEventValidation="false" %>
         ...
         <form id="form1" runat="server" onsubmit="return checkLogin();">
          <div class="inputItem"><label for="username"><span>登录名</span>
           ...
           <asp:TextBox ID="username" CssClass="input" runat="server"></asp:TextBox>
            ...
            <asp:Button ID="login" runat="server" CssClass="loginbutton"   Text="登 录" OnClick="login_Click" /> 
