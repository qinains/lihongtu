<%@ page language="C#" autoeventwireup="true" inherits="OpenAccountResult, App_Web_openaccountresult.aspx.cdcab7d2" enableEventValidation="false" %>
...
<asp:Panel ID="successpage" runat="server">
    ...
    <div style="width:390px;padding:30px 10px 30px 140px;margin:50px auto;background:url(images/bg_haveAccount.png) no-repeat 0 50%">
	    <h3 style="margin:10px auto;font:bold 18px Microsoft Yahei;color:#039">恭喜！<span>您已成功开通号码百事通账户,请在收到短信后，修改你您的支付密码！</span></h3>
