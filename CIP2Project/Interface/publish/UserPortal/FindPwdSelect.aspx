<%@ page language="C#" autoeventwireup="true" inherits="FindPwdSelect, App_Web_findpwdselect.aspx.cdcab7d2" enableEventValidation="false" %>
                            ...
                            <table class="tableA">
                                <tr>
                                    <th>
                                        ...
                                        <asp:HyperLink runat="server" ID="linkPhone" NavigateUrl="FindPassWord/FindByEmail.aspx">认证手机重置密码</asp:HyperLink>
                                    </th>
                                    <td>
                                ...
                                <tr>
                                    <th>
                                        <%--<label for="email">
                                           ...
                                           <asp:HyperLink runat="server" ID="linkEmail" NavigateUrl="FindPassWord/FindByPhone.aspx">认证邮箱重置密码</asp:HyperLink>
                                    </th>
                                    <td>
