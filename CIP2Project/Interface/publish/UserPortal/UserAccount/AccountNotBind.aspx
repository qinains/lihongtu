<%@ page language="C#" autoeventwireup="true" inherits="UserAccount_AccountNotBind, App_Web_accountnotbind.aspx.74181853" enableEventValidation="false" %>
...
<body>
    ...
    <div style="width: 390px; padding: 30px 10px 30px 140px; margin: 50px auto; background: url(../images/bg_noAccount.png) no-repeat 0 50%">
        ...
        <a href="../CreateBesttoneAccount.aspx?SPTokenRequest=<%=newSPTokenRequest%>" style="color: #39c;
            font: bold 14px Microsoft Yahei" target="_top">马上开通>></a>
    </div>
