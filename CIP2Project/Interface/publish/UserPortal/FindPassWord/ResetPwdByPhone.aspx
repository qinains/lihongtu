<%@ page language="C#" autoeventwireup="true" inherits="FindPassWord_ResetPwdByPhone, App_Web_resetpwdbyphone.aspx.d026a163" enableEventValidation="false" %>
...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript" src="JS/ResetPwdByPhone.js"></script>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:HiddenField ID="hdPwdType" runat="server" />
    </form>
</body>
</html>
