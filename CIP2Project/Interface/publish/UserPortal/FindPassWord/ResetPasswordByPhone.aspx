<%@ page language="C#" autoeventwireup="true" inherits="FindPassWord_ResetPasswordByPhone, App_Web_resetpasswordbyphone.aspx.d026a163" enableEventValidation="false" %>
    ...
    <form id="form1" runat="server">
        <asp:Panel ID="ResetPanel" runat="server">
            <div class="resetBox">
                <%--<h2>重置密码</h2>--%>
                <label for="password">
                    <span>设置密码：</span><input type="password" id="password" class="input" onblur="doCheckPassword()" /><em>*</em><p
                        id="hintPassword">
                        6-12位,不能含空格</p>
                </label>
                <label for="password2">
                ...
                <label for="checkCode">
                    ...
                    <img width="62" height="30" src="../ValidateToken.aspx" id="IMG2" />
                    <a href="javascript:RefreshViewCode()">看不清？换一张</a>
                    <p id="hintCode"></p>
                </label>
        ...
        <script type="text/javascript">
            ...
            doCheckPassword = function(){
                ...
                if(pwd==""){
                    $("#hintPassword").text("请输入密码");
                    $("#hintPassword").attr("class","hintError");
                    return false;
                }
                if(!regPwd.test(pwd)){
                    $("#hintPassword").text("6-12位,不能含空格");
                    $("#hintPassword").attr("class","hintError");
                    return false;
                }
            }
            ...
            doCheckSurePassword = function(){
                ...
                if(surePwd!=pwd){
                    $("#hintPassword2").text("密码输入有误");
                    $("#hintPassword2").attr("class","hintError");
                    return false;
                }
                if(!regPwd.test(surePwd)){
                    $("#hintPassword2").text("6-12位,不能含空格");
                    $("#hintPassword2").attr("class","hintError");
                    return false;
                }
            }
            ...
            $("#resetFinish").click(function(){
                ...
                $.ajax({
                    ...
                    dataType:"JSON",
                    data:{CustID:custid,PassWord:pwd,Code:viewCode,Type:"ResetPwdByPhone",PwdType:"2",time:time.getTime()},
