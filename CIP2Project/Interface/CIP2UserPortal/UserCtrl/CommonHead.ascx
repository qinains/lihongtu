<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CommonHead.ascx.cs" Inherits="UserCtrl_CommonHead" %>
<div class="head clearfix" id="divHead">
    <div class="fl">
        <img src="images/logoct.gif" /><img style="padding-left: 20px" src="images/logo_besttone.gif"/></div>
<p class="fl">号码百事通账户</p><div class="fr" style="color:#333;font-size:12px;margin-top:30px">合作伙伴：天翼电子商务有限公司<span style="color:#007BC1;margin-left:10px">客服热线：4008-011-888</span></div>
</div>
<style type="text/css">
