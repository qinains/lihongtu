<%@ page language="C#" autoeventwireup="true" inherits="RegisterAllInOne, App_Web_kpte7rfs" enableEventValidation="false" %>
...
<head id="Head1" runat="server">
   ...
   .Yiyou_header,.content{width:980px;position:relative;margin:0 auto 10px} 
    ...
    #register{width:108px;height:38px;margin-left:90px;margin-bottom:20px;border:none;background:url(images/spriteLoginRegister.png) no-repeat 0 -38px;cursor:pointer;display:block;text-indent:-9999px}
...
function mobilePhone() {
	var regMobile = /^1([3][0-9]|[5][012356789]|[8][012356789])\d{8}$/;
...
//验证码发送返回结果
function ResultCheckCode1(Result)
 {
	hasSend=1;
	$("#phonestate").attr("value", Result);
	if (Result == "0"){
    ...
    <div class="content">
        <form id="form1" runat="server">
            <div class="registerBox" id="userBox">
                ...
                <div id="accountInfo">
                <p style="font-size:14px;margin-left:90px;color:#390;height:30px;line-height:30px">以下信息创建后不可随意更改，请填写真实信息。</p>
                ...
                <label class="label" for="acceptUserProtocol"><input type="checkbox" class="checkbox" id="acceptUserProtocol" checked/>我同意<a href="protocolUser.html" target="_blank">《号百通行证用户服务协议》</a>与<a href="protocolAccount.html" target="_blank">《号码百事通账户自助交易服务协议》</a></label> 
                <label class="label" for="registBesttoneAccount"><input type="checkbox" class="checkbox" id="registBesttoneAccount" checked />同步创建<a id="whatBesttone" style="cursor:pointer">号码百事通账户</a></label>
            </div>
