<%@ page language="C#" autoeventwireup="true" inherits="SSO_AuthRegister, App_Web_2mjfkmpd" enableEventValidation="false" %>
...
<div class="authBox">
    ...
    <form id="form1" runat="Server">
        <label for="mobile"><span>手机号：</span><input type="text" id="mobile" class="input" maxlength="11" /><em>*</em><p id="hintMobile">请输入11位手机号码</p></label>
        <label for="checkCode"><span>验证码：</span><input type="text" id="checkCode" class="input" /><span id="sendCode">发送验证码</span><em>*</em><p id="hintCode">请输入收到的验证码</p></label>
        <label for="password"><span>设置密码：</span><input type="password" id="password" class="input" /><em>*</em><p id="hintPassword">6-12位,不能含空格</p></label>
        <label for="password2"><span>确认密码：</span><input type="password" id="password2" class="input" /><em>*</em><p id="hintPassword2">请重复输入密码</p></label>
        <input type="button" value="绑定" id="auth" />
