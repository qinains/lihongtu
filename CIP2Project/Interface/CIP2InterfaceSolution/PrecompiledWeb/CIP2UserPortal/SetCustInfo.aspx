<%@ page language="C#" masterpagefile="~/MasterPage.master" autoeventwireup="true" inherits="setCustInfo1, App_Web_waxseis2" title="Untitled Page" enableEventValidation="false" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="cb">
        <dl>
            ...
            <dd>
                <input type="text" value="" id="usernameTxt" class="texti" runat="server" disabled="disabled" /></dd>
            <dt>
                <label for="username">
        ...
        <dl>
            ...
            <dd>
                <input type="text" id="emailtxt" class="texti" runat="server" disabled="disabled" /><asp:LinkButton
                    ID="LinkButton1" runat="server" OnClick="LinkButton1_Click">修改邮箱</asp:LinkButton>
                <br />
                <br />
            </dd>
            <dt>
