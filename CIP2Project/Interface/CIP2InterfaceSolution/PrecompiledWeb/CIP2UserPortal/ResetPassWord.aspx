<%@ page language="C#" autoeventwireup="true" inherits="ResetPassWord, App_Web_kpte7rfs" enableEventValidation="false" %>
...
%>
     <div style="width:400px;height:150px;position:absolute;left:50%;margin-left:-205px;border:5px solid #39c;border-radius:5px">
	    ...
	    <p style="font:14px Microsoft Yahei;margin:30px auto 10px;text-align:center">密码已重置成功</p>
...
%>
        ...
        <div class="content">
            ...
            <form id="form1" runat="Server">
                ...
                <label for="checkCode"><span>验证码：</span><input type="text" id="checkCode" name="checkCode" class="input"/><span id="sendCode" onclick="SendPhoneAuth()">发送验证码</span><em>*</em><p id="hintCode" runat="Server">请输入收到的验证码</p></label>
