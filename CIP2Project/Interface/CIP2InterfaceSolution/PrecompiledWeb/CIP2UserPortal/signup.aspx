<%@ page language="C#" autoeventwireup="true" enableviewstate="true" inherits="signup, App_Web_kpte7rfs" enableEventValidation="false" %>
...
<head id="Head1" runat="server">
    ...
    <script language="javascript" event="onclick()" for="btn_OK">
