<%@ page language="C#" autoeventwireup="true" inherits="ChangePayPWD2, App_Web_kpte7rfs" enableEventValidation="false" %>
...
%>
     <div style="width:400px;height:150px;position:absolute;left:50%;margin-left:-205px;border:5px solid #39c;border-radius:5px">
        ...
        <a href="<%=ReturnUrl%>"  target="_top" style="display:block;margin:0 auto;width:124px"><img src="images/finishReturn.gif" width="106" height="26" alt=""></a>
    </div>
...
%>
        ...
        <div class="content">
            ...
            <form id="form1"  runat="Server">
                <label for="password"><span>旧支付密码：</span><input type="password" id="oldPassWord" class="input"/><em>*</em><p id="hintPassword">请填写您的旧支付密码</p></label>
                <label for="password"><span>设置新支付密码：</span><input type="password" id="newPassWord" class="input"/><em>*</em><p id="hintPassword1">只能由数字组成，且不能含空格</p></label>
                <label for="password2"><span>确认新支付密码：</span><input type="password" id="confirmPassWord" class="input"/><em>*</em><p id="hintPassword2">请重复输入密码</p></label>
