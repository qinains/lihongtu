<%@ page language="C#" autoeventwireup="true" inherits="CreateBesttoneAccount, App_Web_kpte7rfs" enableEventValidation="false" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function checkContactTel(){
            var regMobile=/^1([3][0-9]|[5][012356789]|[8][01256789])\d{8}$/;		//手机号验证
       ...
       //发送手机验证码ajax
        ...
        function CheckForm(){   
	         if(mobilePhone() && $("#realName").val() != ""  && $("#sex").val() != ""  && $("#certnum").val() != ""){
		        if(mobileChecked==0){
		            if($("#checkCode").val() != ""){
		                return true;
		            }else{
